  ...
  return (
    <div className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200 sm:p-12">
      ...
      <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">
        Stripe reports the checkout session as complete. The cart on this device has been cleared.
        Order persistence is not enabled yet because the current Prisma schema does not include
        order tables.
      </p>
      {sessionId && (
